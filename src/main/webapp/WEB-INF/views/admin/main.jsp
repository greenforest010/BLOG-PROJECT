...
<html lang="en">
  <head>
    ...
    <link href="resources/admin/vendors/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css" rel="stylesheet">
    <!-- jVectorMap -->
    <link href="resources/admin/css/maps/jquery-jvectormap-2.0.3.css" rel="stylesheet"/>
  ...
  <body class="nav-md">
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <li role="presentation" class="dropdown">
                  ...
                  <ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
                    <li>
                      <a>
                        <span class="image"><img src="resources/admin/images/img.jpg" alt="Profile Image" /></span>
                        <span>
    ...
    <!-- gauge.js -->
    <script src="resources/admin/vendors/bernii/gauge.js/dist/gauge.min.js"></script>
    <!-- bootstrap-progressbar -->
    ...
    <!-- Flot plugins -->
    <script src="resources/admin/js/flot/jquery.flot.orderBars.js"></script>
    <script src="resources/admin/js/flot/date.js"></script>
    <script src="resources/admin/js/flot/jquery.flot.spline.js"></script>
    <script src="resources/admin/js/flot/curvedLines.js"></script>
    <!-- jVectorMap -->
    <script src="resources/admin/js/maps/jquery-jvectormap-2.0.3.min.js"></script>
    <!-- bootstrap-daterangepicker -->
    <script src="resources/admin/js/moment/moment.min.js"></script>
    <script src="resources/admin/js/datepicker/daterangepicker.js"></script>
    ...
    <!-- jVectorMap -->
    <script src="resources/admin/js/maps/jquery-jvectormap-world-mill-en.js"></script>
    <script src="resources/admin/js/maps/jquery-jvectormap-us-aea-en.js"></script>
    <script src="resources/admin/js/maps/gdp-data.js"></script>
    <script>
      $(document).ready(function(){
